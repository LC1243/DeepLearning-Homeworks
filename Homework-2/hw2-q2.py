...
class CNN(nn.Module):
    def __init__(self, dropout_prob, maxpool=True, batch_norm=True, conv_bias=True):
        ...
        self.conv_block1 = ConvBlock(channels[0], channels[1], dropout=dropout_prob)
        self.conv_block2 = ConvBlock(channels[1], channels[2], dropout=dropout_prob)
        self.conv_block3 = ConvBlock(channels[2], channels[3], dropout=dropout_prob)
